...
import lab10.employeebst.Employee;
import lab10.employeebst.NameComparator;
...
public class EmployeeBST {
    ...
    private void printTree(Node t) {
        if (t != null) {
            printTree(t.left);
            System.out.println(t.element.getName());
            printTree(t.right);
        }
    }
    ...
    public static void main(String[] args) {
       /*
        ...
        EmployeeBST bst = new EmployeeBST(nameComparator);
        for (int i = 15; i >= 0; --i) {
